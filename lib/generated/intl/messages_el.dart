...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("Πίνακας σύνδεσης STPOS"),
        ...
        "mobiPosLoginPanel":
            MessageLookupByLibrary.simpleMessage("Πίνακας Σύνδεσης STPOS"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("Πίνακας Εγγραφής STPOS"),
        ...
        "stayAtTheForFront": MessageLookupByLibrary.simpleMessage(
            "Μείνετε στην πρώτη γραμμή των τεχνολογικών εξελίξεων χωρίς πρόσθετο κόστος. Η αναβάθμιση του STPOS POS Unlimited εξασφαλίζει ότι θα έχετε πάντοτε τα τελευταία εργαλεία και χαρακτηριστικά στη διάθεσή σας, εξασφαλίζοντας ότι η επιχείρησή σας παραμένει στην αιχμή."),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "Το όνομα λέει τα πάντα. Με το STPOS POS Unlimited, δεν υπάρχει περιορισμός στη χρήση σας. Είτε επεξεργάζεστε μια χειροτερία συναλλαγών είτε βιώνετε μια έξαρση πελατών, μπορείτε να λειτουργείτε με αυτοπεποίθηση, γνωρίζοντας ότι δεν περιορίζεστε από περιορισμούς."),
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "Ξεκλειδώστε την πλήρη δυνατότητα του STPOS POS με εξατομικευμένες συνεδρίες εκπαίδευσης που ηγούνται από την ομάδα ειδικών μας. Από τις βασικές μέχρι τις προηγμένες τεχνικές, εξασφαλίζουμε ότι θα είστε καλά εξοικειωμένοι με τη χρήση κάθε πτυχής του συστήματος για τη βελτιστοποίηση των επιχειρηματικών σας διαδικασιών."),
