...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("STPOS Логин панели"),
        ...
        "mobiPosLoginPanel":
            MessageLookupByLibrary.simpleMessage("STPOS Кіру Панелі"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("STPOS Тіркелу Панелі"),
        ...
        "pleaseentervaliddata":
            MessageLookupByLibrary.simpleMessage("Тура деректерді енгізіңіз"),
        "posSaasSingUpPanel":
            MessageLookupByLibrary.simpleMessage("STPOS Тіркелу панели"),
        ...
        "safegurardYourBusinessDate": MessageLookupByLibrary.simpleMessage(
            "Сіздің бизнес деректеріңізді оқтасыздар. Біздің STPOS POS Шекті жаңартуы, сіздің арнайы деректеріңізді қору, дайындалмайтын событыларға қарсы қорғау қамтамасыз етуі мүмкін. Сіздің бизнес дамуыңыздың сауатыңа байланысыны жасаңыз."),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "Атты әрбір несіге айналдырады. STPOS POS Шекті, сіздің пайдалануыңызда шектіліктер жоқ. Сіз бір несіге қолдарыңызды қабылдау немесе клиенттердің сүйеуімен жиыладым дейін жұмыс істейсіз деп ойлайсыз, сізді бір несіге қиін емесіңіздің беттік мүмкіндіктерімен шектелмейдігіңізді білуге және сенімділік арттыруға ұмтыларымыздың арқылы."),
