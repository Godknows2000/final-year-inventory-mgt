...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("STPOSログインパネル"),
        ...
        "mobiPosLoginPanel":
            MessageLookupByLibrary.simpleMessage("STPOS ログインパネル"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("STPOS サインアップパネル"),
        "mobilePlusDesktop":
        ...
        "pleaseentervaliddata":
            MessageLookupByLibrary.simpleMessage("有効なデータを入力してください"),
        "posSaasSingUpPanel":
            MessageLookupByLibrary.simpleMessage("STPOSサインアップパネル"),
        ...
        "safegurardYourBusinessDate": MessageLookupByLibrary.simpleMessage(
            "ビジネスデータを簡単に保護します。当社のSTPOS POS Unlimitedアップグレードには無料のデータバックアップが含まれており、貴重な情報が予期せぬイベントから保護されています。本当に重要なこと、つまりビジネスの成長に集中できます。"),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "名前がすべてを物語っています。STPOS POS Unlimitedを使用すると、利用制限がありません。少数の取引を処理している場合でも、多くの顧客が押し寄せている場合でも、制限に縛られないことを知りながら、自信を持って運用できます。"),
        "thisCustmerHasNoDue":
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "エキスパートチームによる個別のトレーニングセッションでSTPOS POSのフルポテンシャルを引き出します。基本から高度なテクニックまで、システムのあらゆる側面を活用してビジネスプロセスを最適化することを確実にします。"),
