...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("پنل ورود به STPOS"),
        ...
        "mobiPosLoginPanel":
            MessageLookupByLibrary.simpleMessage("پنل ورود به STPOS"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("پنل عضویت در STPOS"),
        ...
        "pleaseentervaliddata": MessageLookupByLibrary.simpleMessage(
            "لطفاً داده‌های معتبر وارد کنید"),
        "posSaasSingUpPanel":
            MessageLookupByLibrary.simpleMessage("پنل ثبت نام در STPOS"),
        ...
        "safegurardYourBusinessDate": MessageLookupByLibrary.simpleMessage(
            "حفاظت از داده‌های کسب‌وکار شما بدون دغدغه. بروزرسانی نامحدود STPOS ما شامل پشتیبان‌گیری رایگان از داده است، تضمین می‌کند که اطلاعات ارزشمند شما در مقابل هر نوع حادثه غیرمنتظره محافظت می‌شود. روی رشد واقعی کسب‌وکار خود تمرکز کنید."),
        ...
        "stayAtTheForFront": MessageLookupByLibrary.simpleMessage(
            "با بروزرسانی نامحدود STPOS ما، همیشه آخرین ابزار و ویژگی‌ها در دسترس شما قرار دارد و تضمین می‌شود که کسب و کار شما به‌روز باقی بماند."),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "نام همه چیز را می‌گوید. با STPOS POS Unlimited، محدودیتی بر روی استفاده شما وجود ندارد. برایشمار کردن دست کم تراکنش‌ها یا تجربه شلوغی از مشتریان، شما می‌توانید با اطمینان عمل کنید و بدانید که تحت محدودیت‌ها نیستید."),
        "thisCustmerHasNoDue":
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "پتانسیل کامل STPOS POS را با جلسات آموزش شخصی توسط تیم متخصص ما به دست آورید. از مباحث پایه تا تکنیک‌های پیشرفته، ما تضمین می‌کنیم که شما در استفاده از هر جنبه از سیستم برای بهینه‌سازی فرآیندهای کسب‌وکارتان ماهر شوید."),
