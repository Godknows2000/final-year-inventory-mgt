...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("Bảng đăng nhập STPOS"),
        ...
        "mobiPosLoginPanel": MessageLookupByLibrary.simpleMessage(
            "Bảng điều khiển đăng nhập STPOS"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("Bảng đăng ký STPOS"),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "Tên nói lên tất cả. Với STPOS POS Unlimited, không có giới hạn về việc sử dụng của bạn. Dù bạn đang xử lý một số giao dịch hoặc đối mặt với một lượng khách hàng đông đảo, bạn có thể hoạt động một cách tự tin, biết rằng bạn không bị ràng buộc bởi giới hạn."),
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "Mở khóa tiềm năng đầy đủ của STPOS POS với các buổi đào tạo cá nhân do đội ngũ chuyên gia của chúng tôi dẫn dắt. Từ cơ bản đến các kỹ thuật tiên tiến, chúng tôi đảm bảo bạn đã hiểu rõ cách sử dụng mọi khía cạnh của hệ thống để tối ưu hóa quy trình kinh doanh của bạn."),
