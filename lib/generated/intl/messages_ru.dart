...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("Панель входа STPOS"),
        ...
        "mobiPosLoginPanel":
            MessageLookupByLibrary.simpleMessage("Панель входа в STPOS"),
        "mobiPosSignUpPane":
            MessageLookupByLibrary.simpleMessage("Панель регистрации STPOS"),
        "mobilePlusDesktop":
        ...
        "safegurardYourBusinessDate": MessageLookupByLibrary.simpleMessage(
            "Легко защитите данные вашего бизнеса. Наше бесплатное резервное копирование данных STPOS POS Unlimited обеспечивает защиту ваших ценных данных от непредвиденных событий. Сосредоточьтесь на том, что действительно важно - на росте вашего бизнеса."),
        ...
        "stayAtTheForFront": MessageLookupByLibrary.simpleMessage(
            "Оставайтесь на передовой технологических достижений без дополнительных затрат. Наше бесплатное обновление STPOS POS гарантирует, что у вас всегда будут самые новые инструменты и функции под рукой, обеспечивая сохранение современности вашего бизнеса."),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "Название говорит само за себя. С STPOS POS Unlimited нет ограничений на использование. Независимо от того, обрабатываете ли вы несколько транзакций или сталкиваетесь с наплывом клиентов, вы можете работать с уверенностью, зная, что вы не ограничены лимитами."),
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "Разблокируйте полный потенциал STPOS POS с персональными тренировочными сессиями, проводимыми нашей экспертной командой. От основ до продвинутых техник, мы гарантируем, что вы хорошо знакомы с использованием каждого аспекта системы для оптимизации бизнес-процессов."),
