...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "PosSaasLoginPanel":
            MessageLookupByLibrary.simpleMessage("Panneau de connexion STPOS"),
        ...
        "stayAtTheForFront": MessageLookupByLibrary.simpleMessage(
            "Restez à l\'avant-garde des avancées technologiques sans coûts supplémentaires. Notre mise à niveau illimitée de STPOS POS garantit que vous disposez toujours des derniers outils et fonctionnalités à portée de main, garantissant que votre entreprise reste à la pointe."),
        ...
        "theNameSysIt": MessageLookupByLibrary.simpleMessage(
            "Le nom dit tout. Avec STPOS POS Unlimited, il n\'y a pas de limite à votre utilisation. Que vous traitiez quelques transactions ou que vous soyez submergé de clients, vous pouvez opérer en toute confiance, sachant que vous n\'êtes pas limité par des contraintes."),
        "thisCustmerHasNoDue":
        ...
        "unlockTheFull": MessageLookupByLibrary.simpleMessage(
            "Débloquez tout le potentiel de STPOS POS avec des sessions de formation personnalisées dirigées par notre équipe d\'experts. Des bases aux techniques avancées, nous nous assurons que vous maîtrisez chaque aspect du système pour optimiser vos processus commerciaux."),
        "updateNow":
