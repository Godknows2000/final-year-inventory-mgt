...
class GeneratePdf {
  Future<void> generateDocument(PurchaseTransactionModel transactions,
      PersonalInformationModel personalInformation) async {
                          ...
                          children: [
                            ...
                            pw.Text(
                              NumberToCharacterConverter('en')
                                  .convertDouble(transactions.totalAmount)
                                  .toUpperCase(),
                              style: pw.TextStyle(
                                  color: PdfColors.black,
                                  fontWeight: pw.FontWeight.bold),
    ...
    //           color: PdfColors.red,
    //           padding: const pw.EdgeInsets.all(10.0),
    //           child: pw.Center(child: pw.Text('Powered By Final Year Project', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold))),
    //         ),
    //       ]);
    //     },
    //     build: (pw.Context context) => <pw.Widget>[
