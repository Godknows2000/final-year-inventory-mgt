...
///String appsName = 'Smart Transact Pos';
String appsTitle = 'Final Year Inventory Mgt Project';
String pdfFooter = '';
bool isDemo = false;
String demoText = 'You Can\'t change anything in demo mode';
String sideBarLogo = '';
String appLogo = '';
String appsName = 'My Inventory';
String madeBy = '';
String invoiceFileName = "My Inventory";
...
// String appsName = 'My Inventory';
// String appsTitle = 'My Inventory';
// String pdfFooter = 'POS.com';
// bool isDemo = false;
// String demoText = 'You Can\'t change anything in demo mode';
...
Future<bool> checkUserSubscriptionValidity(
    {required SubscriptionActionType action}) async {
  SubscriptionModel subscriptionModel =
      await CurrentSubscriptionPlanRepo().getCurrentSubscriptionPlans();
  print(
      'DayLeft: ${(DateTime.parse(subscriptionModel.subscriptionDate).difference(DateTime.now())).inDays}');
  print(
      'DayLeft: ${(DateTime.now().difference(DateTime.parse(subscriptionModel.subscriptionDate)))}');
  switch (action) {
