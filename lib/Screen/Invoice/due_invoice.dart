...
class DueInvoice extends StatefulWidget {
  const DueInvoice(
      {Key? key,
      required this.dueTransactionModel,
...
class _DueInvoiceState extends State<DueInvoice> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: res.Responsive(
          mobile: Container(),
          tablet: TabDueInvoice(
              personalInformationModel: widget.personalInformationModel,
              dueTransactionModel: widget.dueTransactionModel),
          desktop: Consumer(
            builder: (_, ref, watch) {
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(widget
                                        .personalInformationModel.pictureUrl
                                        .toString()),
                                    fit: BoxFit.fill),
                              ),
                            )
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  widget.dueTransactionModel.customerType
                                      .toString(),
                                  style:
                                      kTextStyle.copyWith(color: kTitleColor),
                                ),
                        ...
                        child: Column(
                          children: [
                            SizedBox(
                              ...
                              child: DataTable(
                                headingRowColor:
                                    MaterialStateProperty.all(kRedTextColor),
                                ...
                                rows: List.generate(
                                    ...
                                    (index) => DataRow(
                                          cells: [
                                            DataCell(
                                              Text(widget.dueTransactionModel
                                                  .invoiceNumber),
                                            ),
                                            DataCell(
                                              Text(widget
