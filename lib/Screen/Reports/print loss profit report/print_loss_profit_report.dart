    ...
    pw.MultiPage(
            ...
            pw.Center(
              child: pw.Text(
                ...
                style: pw.Theme.of(context)
                    .defaultTextStyle
                    .copyWith(color: PdfColors.black, fontSize: 11.0),
              ),
            ),
      ...
      footer: (pw.Context context) {
        return pw.Column(children: [
          ...
          pw.Center(
              child: pw.Text('Powered By $pdfFooter',
                ...
                for (int i = 0; i < transactions.length; i++)
                  <String>[
                    ...
                    (DateFormat.yMd().format(DateTime.parse(
                        transactions.elementAt(i).purchaseDate))),
                    (transactions.elementAt(i).invoiceNumber),
                    (transactions.elementAt(i).customerName),
                    (myFormat.format(double.tryParse(
                            transactions.elementAt(i).totalAmount.toString()) ??
                        0)),
                    (myFormat.format(double.tryParse(
                            transactions.elementAt(i).lossProfit!.isNegative
                                ? ' 0'
                                : transactions
                                    .elementAt(i)
                                    .lossProfit!
