                          ...
                          children: [
                            ...
                            Consumer(builder: (_, ref, watch) {
                              ...
                              return transactionReport.when(
                                ...
                                for (var element
                                    in transaction.reversed.toList()) {
                                  if ((element.invoiceNumber
                                      ...
                                      (selectedDate.isBefore(DateTime.parse(element.purchaseDate)) ||
                                          DateTime.parse(element.purchaseDate)
                                              .isAtSameMomentAs(
                                                  selectedDate)) &&
                                      (selected2ndDate.isAfter(DateTime.parse(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          reTransaction[index].purchaseDate.substring(
                                                                              0,
                                                                              10),
                                                                          overflow:
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          myFormat.format(double.tryParse(reTransaction[index].totalAmount.toString()) ??
                                                                              0),
                                                                          style:
                                                                              kTextStyle.copyWith(color: kGreyTextColor),
                                                                          maxLines:
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          myFormat.format(double.tryParse(reTransaction[index].dueAmount.toString()) ??
                                                                              0),
                                                                          style:
                                                                              kTextStyle.copyWith(color: kGreyTextColor),
                                                                          maxLines:
                                                                            ...
                                                                            itemBuilder: (BuildContext bc) =>
                                                                              ...
                                                                              PopupMenuItem(
                                                                                child: GestureDetector(
                                                                                  onTap: () async {
                                                                                    await GeneratePdfAndPrint().printSaleInvoice(personalInformationModel: profile.value!, saleTransactionModel: reTransaction[index]);
                                                                              ...
                                                                              PopupMenuItem(
                                                                                child: GestureDetector(
                                                                                  onTap: () async {
                                                                                    AnchorElement(href: "data:application/octet-stream;charset=utf-16le;base64,${base64Encode(await generateSaleDocument(personalInformation: profile.value!, transactions: reTransaction[index]))}")
                            ...
                            const PurchaseReturnWidget()
                                .visible(selected == 'Purchase Return'),
                            ...
                            const DailyTransaction()
                                .visible(selected == 'Daily Transaction'),
                            ...
                            const LossProfitReport()
                                .visible(selected == 'Loss/Profit report'),
                          ],
                        ),
                      ),
                      Visibility(
